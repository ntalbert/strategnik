...
This is where the [physics of momentum](/physics-of-growth/momentum) matters. In physics, momentum is mass times velocity — but the useful insight isn't the formula. It's the asymmetry. Building momentum requires sustained force over time against resistance. Once an object has momentum, it requires very little energy to maintain. And stopping it, then restarting from zero, costs more than the original investment because you've lost all the accumulated energy.

...
The [Physics of Growth](/physics-of-growth) section of this site explores each concept in depth. What follows here is the complete framework: six forces, how they interact, and how a GTM leader applies them to make better investment decisions.
...
This is why [GTM leaders churn at early-stage SaaS companies](/thinking/why-gtm-leaders-churn-early-stage-saas) — they're asked to produce momentum-stage results in a mass-building phase. The system is too light for the force being applied.
...
**The implication:** Surface area determines how many paths lead back to you. In a world where [AI is collapsing the walls between discovery channels](/thinking/ai-collapsing-gtm-walls), the companies with the widest surface area are the ones AI systems aggregate signal from most effectively. An [intelligence layer](/intelligence-layer) that maps where your market actually pays attention — and where you're absent — is the diagnostic tool for surface area gaps.
...
The [deep dive on momentum](/physics-of-growth/momentum) covers the diagnostic indicators. The critical insight here is that momentum is asymmetric: it takes sustained force over time to build, almost nothing to maintain once achieved, and far more than the original investment to rebuild if you stop and restart from zero.

This is why [growth programs that look like they're failing are often the ones most worth protecting](/thinking/momentum-marketing-investments). The compounding curve — flat for months, then steep — is specifically designed to fool quarterly review cycles into killing programs before they inflect. The investments that compound are the ones you're most tempted to cut.
...
The [friction deep dive](/physics-of-growth/friction) catalogs where friction hides — cognitive friction (messaging too complex to parse), process friction (internal procedures imposed on buyers), and trust friction (missing social proof and credibility signals). I wrote separately about [the compound cost of friction](/thinking/friction-problem) — the fact that friction doesn't just lose you the individual lead, it trains the market that you're hard to work with.
...
The [funnel math](/thinking/funnel-math-kills-the-deal) makes this explicit. Most revenue plans fail because the conversion assumptions are internally inconsistent, and the inconsistency is usually hidden friction that nobody audited.
...
**The GTM analog:** The inflection point is the moment when incremental investment starts yielding exponential returns. Before it, you're building. After it, you're scaling. The entire question of growth timing — [when to scale](/thinking/inflection-points) — reduces to whether you've crossed this threshold.
...
**If you're a founder or CEO:** The framework tells you what kind of investment to prioritize and what metrics to track at each stage. If your company has almost no mass, you're in a mass-building phase — and [the metrics that matter](/thinking/stage-appropriate-gtm-metrics-saas) are mass indicators (brand search volume, domain authority, content depth), not pipeline volume. If you've been investing consistently and the compounding curve hasn't inflected yet, the question isn't whether to cut — it's whether you've given the physics enough time to work.
...
**If you're a board member or investor:** The framework explains why GTM leader churn is [structural at early stages](/thinking/why-gtm-leaders-churn-early-stage-saas), why the best growth programs [look like they're failing in their first year](/thinking/momentum-marketing-investments), and why premature scaling produces the exact outcome it was supposed to prevent. The question isn't "are we growing fast enough?" It's "do we have the mass to support the velocity we're demanding?"
